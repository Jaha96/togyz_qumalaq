...
class Board():
    ...
    def possible_move(self,player_color: PlayerColor):
        ...
        for pit in player.pits:
            if pit.seed_count <= 1 or pit.is_tuzdik:
                continue
            ...
            # temp_board.player_list[player_index].pits[pit_index].seed_count = 0
            color_index = player_index
            
            for seed in range(pit.seed_count):
                if player_index == color_index:
                    ...
                    if temp_board.player_list[color_index].pits[pit_index].is_tuzdik:
                        ...
                        elif temp_board.player_list[color_index].pits[pit_index].seed_count == 3 and temp_board.player_list[color_index].pits[pit_index].pit_index !=9 and temp_board.player_list[color_index].tuzdik == False:
                            move = "tuzdik"
                            kazan_point += temp_board.player_list[color_index].pits[pit_index].seed_count
                            temp_board.player_list[color_index].pits[pit_index].seed_count = 0
                        else:
